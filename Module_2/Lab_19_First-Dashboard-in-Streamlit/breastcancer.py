...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 24 11:20:04 2022
...
st.sidebar.markdown("### Scatter Chart: Relationship Between Measurements :")
...
if x_axis and y_axis:
    ...
    malignant_df.plot.scatter(x=x_axis, y=y_axis, s=120, c="red", alpha=0.6, ax=scatter_ax, label="Malignant")
    benign_df.plot.scatter(x=x_axis, y=y_axis, s=120, c="green", alpha=0.6, ax=scatter_ax,
...
st.sidebar.markdown("### Histogram: Distribution of Measurements : ")
...
st.sidebar.markdown("### Hexbin Chart: Density of Measurements :")
...
if hexbin_x_axis and hexbin_y_axis:
    ...
    breast_cancer_df.plot.hexbin(x=hexbin_x_axis, y=hexbin_y_axis,
                                 ...
                                 gridsize=25,
                                 cmap="Blues",
                                 ax=hexbin_ax, title="Density of Measurements");
