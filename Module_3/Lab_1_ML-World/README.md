...
They have used Deep Neural Networks. Depp learning is a part of ML that uses neural algorithms to predict.
...
Researchers from Kyoto University have developed a method to reconstruct by artificial intelligence the images created in brain upon visual stimuli. They have used deep neural network (DNN) to decode and predict the images seen by the subjects. 

They have done this by showing images to subjects while their brain activity was followed using functional magnetic resonance imaging(fMRI). The data they have obtained by fMRI were then decoded by comparing the neural network patterns with image data from a database. 

DNN is used in other areas as well. Chatbots, language recognition, autonomous vehicles are some examples.

This research is considered as a small step towards mind-reading. There are ethical concerns that come with it. Unfortunately, 
